...
def test_ft_exercise(exercise_file_name, i):
    """
    ...
    try:
        ...
        ft_module = __import__(
            f"ex{i}.{exercise_file_name}", fromlist=["file"]
        )
...
def main():
    ...
    if choice == "0":
        ...
        test_ft_exercise("ft_plot_area", "1")
        test_ft_exercise("ft_harvest_total", "2")
        test_ft_exercise("ft_plant_age", "3")
        test_ft_exercise("ft_water_reminder", "4")
        test_ft_exercise("ft_count_harvest_iterative", "5")
        test_ft_exercise("ft_count_harvest_recursive", "5")
        test_ft_exercise("ft_garden_summary", "6")
